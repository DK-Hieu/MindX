...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`LT_DE2` /*!40100 DEFAULT CHARACTER SET latin1 */;

Drop table if EXISTS `Khachhang`;

create table Khachhang (`MAKH` char(4),`HOTEN` varchar(40), `DCHI` varchar(50), `SODT` varchar(20), `NGSINH` date, `NGDK` date, `DOANGSO` int);
...
('KH05','Le Nhat Minh','34 Truong Dinh, Q3, TpHCM',08246108,'1950-10-03','2006-10-28',21000),
('KH06','Le Hoai Thuong','227 Nguyen Van Cu, Q5, TpHCM',08631738,'1981-12-31','2006-11-24',915000),
('KH07','Nguyen Van Tam','32/3 Tran Binh Trong, Q5, TpHCM',0916783565,'1971-06-04','2006-01-12',12500),
...
('KH10','Ha Duy Lap','34/34B Nguyen Trai, Q1, TpHCM',08768904,'1983-02-05','2007-01-16',67500);


Drop table if EXISTS `Nhanvien`;

create table Nhanvien(`MANV` char(4), `HOTEN` varchar(40), `SODT` varchar(20), `NGVL` date);
...
create table Sanpham(`MASP` char(4), `TENSP` varchar(40), `DVT` varchar(20), `NUOCSX` varchar(40), `GIA` int);
...
create table Hoadon(`SOHD` int, `NGHD` date, `MAKH` char(4), `MANV` char(4), `TRIGIA` int);

insert into Hoadon 
values
(1001,'2006-07-23','KH01','NV01',320000),
(1002,'2006-12-08','KH01','NV02',840000),
...
(1011,'2006-04-11','KH04','NV03',250000),
